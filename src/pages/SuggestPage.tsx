    ...
    return (
      <div className="min-h-screen bg-[#F7FFF7] flex items-center justify-center section-padding">
        <div className="card-dark p-10 max-w-md w-full text-center">
          ...
          <h2 className="text-2xl font-bold text-[#111827] mb-2">Thank you</h2>
  ...
  return (
    <div className="min-h-screen bg-[#F7FFF7]">
      ...
      <div className="section-padding pb-0 max-w-2xl mx-auto">
        <span className="inline-block px-3 py-1 text-xs font-mono uppercase tracking-widest text-[#6B7280] bg-gray-50 rounded-full mb-4">
          Community Input
        </span>
        ...
        <div className="grid grid-cols-2 gap-3 mb-10">
          {[
            ...
            <div key={i} className="card-dark p-4">
              <p className="text-sm font-bold text-[#111827] mb-1">{item.label}</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-[#111827] placeholder:text-[#6B7280]/50 focus:outline-none focus:border-[#EF4444]/50 transition-colors text-sm"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-[#111827] mb-2">Email (optional)</label>
              <input
                type="email"
                value={form.email}
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-[#111827] focus:outline-none focus:border-[#EF4444]/50 transition-colors text-sm appearance-none"
            >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-[#111827] placeholder:text-[#6B7280]/50 focus:outline-none focus:border-[#EF4444]/50 transition-colors text-sm resize-none"
            />
          </div>
