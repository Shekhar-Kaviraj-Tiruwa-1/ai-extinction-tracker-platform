  ...
  return (
    <div className="min-h-screen bg-[#F7FFF7]">
      ...
      <section className="section-padding max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-[#111827] mb-2">Individual Actions</h2>
        ...
        <div className="card-dark p-6 lg:p-8 mb-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-xl font-bold text-[#111827]">1. Dietary Transition</h3>
              <p className="text-sm text-[#6B7280]">Highest single-action impact on land use, water, and emissions</p>
            </div>
          </div>
            ...
            <div className="space-y-3">
              {dietSteps.map((step, i) => (
                <div key={i} className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <p className="text-sm text-[#111827] font-medium">{step.action}</p>
                    <p className="text-xs text-[#6B7280] mt-0.5">{step.impact}</p>
                  </div>
                </div>
              ))}
            </div>
            <div className="card-dark p-5 bg-[#10B981]/5">
              <h4 className="text-sm font-bold text-[#111827] mb-4">If 1 billion people reduced meat by 50%:</h4>
              <div className="space-y-3">
                {[
              ...
              <p className="text-xs text-[#6B7280]/60 font-mono mt-4">Source: FAO; IPBES, 2019</p>
            </div>
          </div>
        </div>
        ...
        <div className="card-dark p-6 lg:p-8 mb-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-xl font-bold text-[#111827]">2. Conscious Consumption</h3>
          </div>
          <p className="text-sm text-[#6B7280] mb-5">
            Beef production drives <span className="text-[#111827] font-semibold">41% of global deforestation</span>.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {consumptionSteps.map((step, i) => (
              <div key={i} className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-sm text-[#6B7280]">{step.action}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="card-dark p-6 lg:p-8 mb-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-xl font-bold text-[#111827]">3. Support Conservation Organisations</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {conservationOrgs.map((org, i) => (
              ...
              >
                <div>
                  <p className="text-sm font-bold text-[#111827] group-hover:text-[#8B5CF6] transition-colors">{org.name}</p>
                  <p className="text-xs text-[#6B7280] mt-1">{org.role}</p>
                </div>
              </a>
            ))}
          </div>
        ...
        <div className="card-dark p-6 lg:p-8 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#111827]">4. Reduce Resource Consumption</h3>
          </div>
          <div className="p-4 bg-[#06B6D4]/10 border border-[#06B6D4]/20 rounded-lg">
            <p className="text-sm text-[#6B7280]">
              <span className="text-[#111827] font-medium">Key insight: </span>
        ...
        <div className="card-dark p-6 lg:p-8 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-[#111827]">5. Advocacy & Education</h3>
          </div>
      ...
      <section className="section-padding pt-0 max-w-7xl mx-auto">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#111827]">Conservation Works</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {recoveries.map((r, i) => (
            <div key={i} className="card-dark p-5">
              ...
              <p className="text-sm text-[#6B7280]">{r.fact}</p>
            </div>
          ))}
        </div>
        <p className="text-xs text-[#6B7280]/60 font-mono mt-4">
